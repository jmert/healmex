# FindMatlab.cmake based on CMake's source at commit 62709bef along with
# patches from PR https://gitlab.kitware.com/cmake/cmake/merge_requests/2442
# applied, as of 2018 Oct 17.
...
#          [MEX_API api]
#          [MATLAB_DEFAULT_RELEASE MATLAB_DEFAULT_RELEASE]
#          [...]
#      )
#
#   ``NAME``
...
function(matlab_add_mex)
  ...
  set(oneValueArgs NAME DOCUMENTATION OUTPUT_NAME MEX_API MATLAB_DEFAULT_RELEASE)
  ...
  if(NOT ${prefix}_MATLAB_DEFAULT_RELEASE)
    set(${prefix}_MATLAB_DEFAULT_RELEASE "R2017b")
  endif()

  set(_valid_MATLAB_DEFAULT_RELEASE "R2017b;R2018a")
  if(NOT ${prefix}_MATLAB_DEFAULT_RELEASE IN_LIST _valid_MATLAB_DEFAULT_RELEASE)
    message(FATAL_ERROR "[MATLAB] MATLAB_DEFAULT_RELEASE must be one of ${_valid_MATLAB_DEFAULT_RELEASE}")
  endif()

  if(NOT ${Matlab_VERSION_STRING} VERSION_LESS "9.4") # For 9.4 (R2018a) and newer, add API macro
      set(MEX_API_MACRO "MATLAB_MATLAB_DEFAULT_RELEASE=${${prefix}_MATLAB_DEFAULT_RELEASE}")
  endif()
  ...
  if(WIN32)
    ...
    if(NOT ${Matlab_VERSION_STRING} VERSION_LESS "9.4" AND ${_mex_api} STREQUAL "C++")
      # Linux (at least in R2018a) doesn't have a cppMexFunction.map file,
      # and the mex executable uses only c_exportsmexfileversion.map.
      # Copy that behavior.
      if (WIN32 OR APPLE)
        list(APPEND _ver_map_files ${Matlab_EXTERN_LIBRARY_DIR}/cppMexFunction.map)
      endif()
    endif()
...
if(WIN32)
  ...
  set(_matlab_lib_dir_for_search ${Matlab_BINARIES_DIR} ${Matlab_EXTERN_BINARY_DIR})
  set(_matlab_lib_prefix_for_search "lib")
endif()
